...
temp_gene_pro<-unique(all_data_genes$get_gene_pos[!is.na(all_data_genes$get_gene_pos$`3_utr_start`) & all_data_genes$get_gene_pos$ensembl_transcript_id %in% all_data_genes_pro$get_gene_pos[all_data_genes_pro$get_gene_pos$transcript_biotype=="protein_coding","ensembl_transcript_id"],c("ensembl_gene_id","ensembl_transcript_id","3_utr_start","3_utr_end","len_3UTR")])

temp_gene_pro2<-unique(all_data_genes$get_gene_pos[!is.na(all_data_genes$get_gene_pos$`3_utr_start`) & all_data_genes$get_gene_pos$ensembl_transcript_id %in% all_data_genes_pro$get_gene_pos[all_data_genes_pro$get_gene_pos$transcript_biotype=="protein_coding","ensembl_transcript_id"],c("ensembl_gene_id","ensembl_transcript_id","len_3UTR")])
...
gene_trans_pro<-unique(all_data_genes$get_gene_pos[all_data_genes$get_gene_pos$ensembl_transcript_id %in% all_data_genes_pro$get_gene_pos[all_data_genes_pro$get_gene_pos$transcript_biotype=="protein_coding","ensembl_transcript_id"],1:2])
