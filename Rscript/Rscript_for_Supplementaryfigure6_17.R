...
tiff("./result/supplymentary_figure17.tiff",width = 17,height = 14,res=300,units="in",compression = "lzw")
...
tiff("./result/supplymentary_figure6.tiff",width = 13,height = 13,res=300,units="in",compression = "lzw")
