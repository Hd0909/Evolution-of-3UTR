...
sif_repicm6a3_array=getsigm6a_diff(all_data_other_cohort_filtered,repicm6a_3utr,2,"diff_exp")
...
tiff("./result/supplymentary_figure12.tiff",width = 17.5,height = 13,res=300,units="in",compression = "lzw")
print(p_all1)
dev.off()



tiff("./result/supplymentary_figure13.tiff",width = 13,height = 13,res=300,units="in",compression = "lzw")
